...
#SBATCH --mem 10666
#SBATCH --ntasks 6
#SBATCH --output="/panfs/pan.fsl.byu.edu/scr/grp/fslg_hwr/taylor_simple_hwr/configs/baseline_warp/log_warp_lr_schedule.slurm"
...
python - u train.py --config warp_lr_schedule.yaml
