...
#SBATCH --mem 10666
#SBATCH --ntasks 6
#SBATCH --output="/panfs/pan.fsl.byu.edu/scr/grp/fslg_hwr/taylor_simple_hwr/slurm_scripts/scripts/log_online_only.slurm"
...
which python
python -u train.py --config '/media/data/GitHub/simple_hwr/configs/online_only.yaml'
