...
#SBATCH --mem 10666
#SBATCH --ntasks 6
#SBATCH --output="/panfs/pan.fsl.byu.edu/scr/grp/fslg_hwr/taylor_simple_hwr/configs/baseline_warp_online/log_two_stage_warp_online.slurm"
...
python - u train.py --config two_stage_warp_online.yaml
