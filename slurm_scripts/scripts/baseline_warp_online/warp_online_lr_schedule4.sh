...
#SBATCH --mem 10666
#SBATCH --ntasks 6
#SBATCH --output="/panfs/pan.fsl.byu.edu/scr/grp/fslg_hwr/taylor_simple_hwr/configs/baseline_warp_online/log_warp_online_lr_schedule4.slurm"
...
python - u train.py --config warp_online_lr_schedule4.yaml
